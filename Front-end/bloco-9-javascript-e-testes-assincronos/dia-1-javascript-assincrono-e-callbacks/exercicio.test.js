...
// const sendMarsTemperature = (param) => setTimeout(() => console.log(`Mars temperature is: ${param()} degree Celsius`), messageDelay())
...
// const sendMarsTemperature = (param1, erro) => {
...
//   it('verifica se "ola" sai "OLA"', (done) => {
//       uppercase('BOLA', (str) => {
//           try {
//               expect(str).toBe('OLA');
//               done()       
...
describe("A função getPokemonDetails", () => {
  ...
  getPokemonDetails((pokemon) => pokemon.name === 'Ola', callback)
})

  it("retorna um pokemon que existe no banco de dados", (done) => {
    const esperada = 'Olá, seu pokémon é o Charmander, o tipo dele é Fire e a habilidade principal dele é Ember';
    
    function callback(err, result) {
      expect(result).toBe(esperada)
      done()
    }
